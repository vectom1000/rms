...
urlpatterns = [
    ...
    url(r'^loesche_kategorie/(?P<kategorie_id>[0-9]{1,10})/$', rms_app.views.loesche_kategorie, name='loesche_kategorie'),
    url(r'^bearbeite_gericht/(?P<gericht_id>[0-9]{1,10})/$', rms_app.views.bearbeite_gericht, name='bearbeite_gericht'),
    url(r'^bearbeite_kategorie/(?P<kategorie_id>[0-9]{1,10})/$', rms_app.views.bearbeite_kategorie, name='bearbeite_kategorie'),
